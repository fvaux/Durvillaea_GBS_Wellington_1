...
vcftools --vcf nznorth-well-4-p1-r85-B.vcf  --interchrom-geno-r2 --min-r2 0.8
...
vcftools --vcf nznorth-well-4-p1-r85-B.vcf --exclude-positions LD1snp.txt --recode --recode-INFO-all